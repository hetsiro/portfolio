...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      github: "disabled",
      demo: "https://cvd-comida-ex-alumnos.vercel.app/compra-tu-preventa/preventa",
    },
    {
          ...
          <section id="contact" className="container mx-auto px-4 py-16">
            ...
            >
              <div className="max-w-2xl mx-auto text-center bg-gray-900/85 hover:scale-105 transition-all rounded-2xl p-8">
                ...
                <SplineScene
                  sceneUrl="https://prod.spline.design/aYwAg-2udgaEgxd6/scene.splinecode"
                  className="invisible md:visible -my-20 clip-polygon"
                />
                <Button
                  size="lg"
                  ...
                  onClick={() => {
                    ...
                    const body =
                      "Hi Cristóbal, I'd like to discuss a project with you.";
